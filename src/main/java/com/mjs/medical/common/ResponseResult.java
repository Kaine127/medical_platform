...
public class ResponseResult<T> implements Serializable {
    ...
    public static ResponseResult okResult(Object data) {
        ResponseResult result = setCodeEnum(CodeEnum.SUCCESS, CodeEnum.SUCCESS.getErrorMessage());
        if(data!=null) {
            result.setData(data);
        }
        return result;
    ...
    public static ResponseResult errorResult(CodeEnum enums, String errorMessage){
    ...
    private static ResponseResult setCodeEnum(CodeEnum enums, String errorMessage){
